...
Version  : 2.5.1
Release  : 46
URL      : https://cran.r-project.org/src/contrib/NMOF_2.5-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/NMOF_2.5-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652461561
