...
Version  : 2.8.0
Release  : 55
URL      : https://cran.r-project.org/src/contrib/NMOF_2.8-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/NMOF_2.8-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697826473
